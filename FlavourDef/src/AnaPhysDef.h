...
class AnaPhysDef : public TSelector {
public :
 ...
 TTree          *fChain = 0;   //!pointer to the analyzed TTree or TChain
  ...
  // TTreeReaderValue<UInt_t> nJet = {fReader, "nJet"}; //NanoAODv9
  TTreeReaderValue<Int_t> nJet = {fReader, "nJet"};     //NanoAODv12
  ...
  // TTreeReaderArray<Int_t> Jet_jetId = {fReader, "Jet_jetId"};//NanoAODv9
  TTreeReaderArray<UChar_t> Jet_jetId = {fReader, "Jet_jetId"};//NanoAODv12
  ...
  // TTreeReaderArray<Int_t> Jet_qgl_mult = {fReader, "Jet_qgl_mult"};//NanoAODv9
  TTreeReaderArray<Short_t> Jet_qgl_mult = {fReader, "Jet_qgl_mult"};//NanoAODv12
  ...
  // TTreeReaderValue<UInt_t> nMuon = {fReader, "nMuon"}; //NanoAODv9
 TTreeReaderValue<Int_t> nMuon = {fReader, "nMuon"};      //NanoAODv12
  ...
  // TTreeReaderArray<Int_t> Jet_genJetIdx = {fReader, "Jet_genJetIdx"};//NanoAODv9
  TTreeReaderArray<Short_t> Jet_genJetIdx = {fReader, "Jet_genJetIdx"}; //NanoAODv12
  // TTreeReaderArray<Int_t> Jet_hadronFlavour = {fReader, "Jet_hadronFlavour"}; //NanoAODv9
  TTreeReaderArray<UChar_t> Jet_hadronFlavour = {fReader, "Jet_hadronFlavour"}; //NanoAODv12
  // TTreeReaderArray<Int_t> Jet_partonFlavour = {fReader, "Jet_partonFlavour"};  //NanoAODv9
  TTreeReaderArray<Short_t> Jet_partonFlavour = {fReader, "Jet_partonFlavour"};  //NanoAODv12

  // TTreeReaderValue<UInt_t> nPhoton = {fReader, "nPhoton"}; //NanoAODv9
  TTreeReaderValue<Int_t> nPhoton = {fReader, "nPhoton"}; //NanoAODv12
  ...
  // TTreeReaderArray<Int_t> Photon_cutBased = {fReader, "Photon_cutBased"};  //NanoAODv9
  TTreeReaderArray<UChar_t> Photon_cutBased = {fReader, "Photon_cutBased"}; //NanoAODv12
  ...
  AnaPhysDef(TTree * /*tree*/ =0) { }
  AnaPhysDef(TString sampleName, TString analysisSel):
    m_sampleName(sampleName),
    m_analyisSelection(analysisSel),
    m_doAnaZPlusJets(false),
    m_doAnaPhotonPlusJets(false),
    m_doAnaDijets(false)
    {
  ...
  void SetAnalysisSelection(){
    if(m_analyisSelection == "ZPlusJets") m_doAnaZPlusJets = true;
    else if(m_analyisSelection == "PhotonPlusJets") m_doAnaPhotonPlusJets = true;
    else if(m_analyisSelection == "Dijets") m_doAnaDijets = true;
    std::cout << "Set Analysis Selection : " << m_analyisSelection << std::endl;
  }


private:
   TString m_sampleName;
   TString m_analyisSelection;
   bool m_doAnaZPlusJets;
   bool m_doAnaPhotonPlusJets;
   bool m_doAnaDijets;
   std::map<TString, TH1D*> m_histosMap;

   template<typename T>
   RVec<T> MakeRVec(TTreeReaderArray<T>& tta){
      return RVec<T>(tta.begin(),tta.end());
   }

public:
   ClassDefOverride(AnaPhysDef,0);
};

#endif

#ifdef AnaPhysDef_cxx
void AnaPhysDef::Init(TTree *tree)
{
